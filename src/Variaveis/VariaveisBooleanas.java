public class VariaveisBooleanas {
    public static void main(String args[]) {
        boolean Maior = true; //variável booleana (que é somente true ou false, de nome "ehMaior" recebe o valor de verdadeiro).
        ...
        System.out.println("O valor da variável de nome Maior é " + Maior + " e a nome é " + nome);
